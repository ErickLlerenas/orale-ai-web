    ...
    <>
      ...
      <main>
        ...
        <section id="precios" className="container">
          ...
          <aside className="plan-warning" aria-label="Requisitos de Pro">
            <svg
              className="plan-warning-icon"
              viewBox="0 0 24 24"
              width="20"
              height="20"
              aria-hidden="true"
            >
              <path
                fill="currentColor"
                d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12z"
              />
            </svg>
            <p>
              <strong>
                Pro necesita WiFi del local e impresora de red para los
                meseros.
              </strong>
              Los meseros mandan comandas a cocina por red. Caja puede seguir
              usando Bluetooth para imprimir la cuenta.
            </p>
          </aside>
        </section>
