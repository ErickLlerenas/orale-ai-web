...
/** Una misma orden recorre mesero, caja e impresión, en ese orden. */
  ...
  return (
    <div className="pro-demo" ref={root} data-step={step}>
      ...
      <div className="pro-demo-scene" aria-hidden="true">
        ...
        <div className="pro-demo-connection" data-reached={step >= 1}><span>→</span></div>

        <div className="pro-demo-station pro-demo-register" data-active={step === 1}>
            ...
            <div className="pro-demo-register-screen">
              ...
              <div className="pro-demo-register-body">
                ...
                <div className="pro-demo-account">
                  ...
                  <div className="pro-demo-received" data-received={step >= 1}>
                  ...
                  <div className="pro-demo-empty" data-show={step === 0}>Esperando el pedido…</div>
                </div>
              </div>
              <div className="pro-demo-notification" data-show={step >= 1}>✓ Pedido recibido · Mesa 3</div>
            </div>
          </div>
          <span className="pro-demo-caption">Tu tablet en caja</span>
        </div>

        <div className="pro-demo-connection" data-reached={step === 2}><span>→</span></div>

        <div className="pro-demo-station pro-demo-kitchen" data-active={step === 2}>
          <div className="pro-demo-printer">
            ...
            <div className="pro-demo-paper-window">
              <div className="pro-demo-ticket" data-printed={step === 2}>
